...
var rootCmd = &cobra.Command{
	Use:   "BFShare",
	Short: "BFShare is a secure file outsourcing and sharing method based on alliance blockchain.",
	Long:  `BFShare is a secure file outsourcing and sharing method based on alliance blockchain. It uses Hyperledger Fabric and Interplanetary File System (IPFS) as the underlying storage engine, which solves the problem of cloud storage security issues.`,
