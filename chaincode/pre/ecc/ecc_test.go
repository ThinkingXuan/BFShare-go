...
import (
	"BFShare-go/internal/encrypt/pre/file"
	"BFShare-go/internal/encrypt/pre/util"
	"crypto/ecdsa"
	"crypto/x509"
	"fmt"
	"log"
...
func TestEcc(t *testing.T) {
	...
	plainText, _ := file.ReadFileBytes("D:\\workspace\\go_workspace\\src\\BFShare-go\\chaincode\\sfscc.go")
